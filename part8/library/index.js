...
const resolvers = {
    ...
    allBooks: (_, args) => {
        if(args.author && args.genre){
            const authorAndGener = books.filter(book => book.author === args.author && book.genres.includes(args.genre))
            return authorAndGener
        } else if(args.author){
            const author = books.filter(book => book.author === args.author)
            return author
        } else if(args.genre){
            const gener = books.filter(book => book.genres.includes(args.genre))
            return gener
        }
